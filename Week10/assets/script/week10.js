...
function greet(guestName = "Guest") {
...
const sayThree = () => {
	console.log("Три!"); //вывод в консоль сообщение "Три!"
}

	sayThree();  // Вызов функции
...
const rabbit = "кролик"; // Переменная объявлена во внешней области видимости

function findAnimal() {
	const cat = "кот"; // Переменная объявлена внутри функции
	console.log(cat + " и " + rabbit); 
}
	findAnimal(); // Вызов функции для вывода значений переменных
...
function calculateAge() {
	console.log(currentYear - friendYearOfBirth);	
}
calculateAge();
...
function calculateMyAge() {
	...
	console.log(currentYear - myYearOfBirth);	
}
calculateMyAge();
//Задание 18
...
power(2, 3); // Вызов функции с числом 2 возводимым в степень 3